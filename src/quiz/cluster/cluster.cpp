...
int main ()
{
	...
	//std::vector<std::vector<float>> points = { {-6.2,7,1}, {-6.3,8.4,2}, {-5.2,7.1,4.2}, {-5.7,6.3,2.5}, {7.2,6.1,4.3}, {8.0,5.3,0.2}, {7.2,7.1,0.4}, {0.2,-7.1, 7.2}, {1.7,-6.9, 5.2}, {-1.2,-7.2,3.6}, {2.2,-8.9,4.1} };
